...
- Adam Brown, "CRASHing: Predicting Amount of Blood Products Required After Significant Hemorrhage"
    - The CRASH-2 (Clinical Randomization of an Antifibrinolytic in Significant Hemorrhage) trial was a randomized, placebo-controlled, double-blind trial of whether tranexamic acid (TXA) use would improve mortality in trauma patients with significant hemorrhage that was [reported in The Lancet in 2010](https://www.thelancet.com/crash-2-2010). The de-identified data on 20,207 patients are available through [the Freebird site (registration required)](https://ctu-app.lshtm.ac.uk/freebird/index.php/data-sharing/downloads/crash2/).
