...
- **Lydia Raines**, "Milk consumption and its effect on blood ApoB levels"
    - [NHANES](https://wwwn.cdc.gov/nchs/nhanes/Default.aspx) 2011-2014 data, including information on Apolipoprotein (B) in mg/dl (the key outcome - and an important component of many lipoproteins that are connected to cardiovascular disease) and milk consumption (amount in the last 30 days, and type of milk consumed - 1%, 2%, skim, etc.) as well as age, sex, race, smoking status, alcohol consumption, total cholesterol and BMI. Data sources: [2011-12](https://wwwn.cdc.gov/nchs/nhanes/continuousnhanes/default.aspx?BeginYear=2011), and 2013-14(https://wwwn.cdc.gov/nchs/nhanes/continuousnhanes/default.aspx?BeginYear=2013).
...
- **Julia Yang**, "Clinical Measures to predict Prostate Specific Antigen levels"
    - Uses de-identified, appropriate-to-share data on 1,291 subjects who have a PSA measurements in the Prostate MRI database at UH's Department of Urology. 
